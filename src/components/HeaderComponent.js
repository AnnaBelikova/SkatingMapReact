            ...
            <Jumbotron>
                ...
                <div className = "container" >
                    <div className = "row row-header" >
                        <div className = "jumbotron__info col-12 col-sm-6" >
                            <h1 > Интерактивная карта для роллеров Санкт-Петербурга </h1> 
                            <p> Проект для тех, кто любит передвигаться по городу на 8 колесах. Интерактивная карта позволит избежать столкновений с перекопаными улицами, попробовать интересные маршруты и даже поделитmся своими.</p> 
                        </div> 
                    </div> 
                </div> 
            </Jumbotron> 
