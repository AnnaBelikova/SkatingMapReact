export const NEWS =
    [
        ...
        {
        id: 2,
        title:'Ведутся ремонтные работы на Просвещения',
        image: '/assets/images/repair.jpg',
        category: 'repair',
        ...
        {
        id: 3,
        title:'Отличный кусок для полосить недалеко от Комендантского!!!',
